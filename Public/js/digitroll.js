...
DigitRoll.prototype={
    ...
    roll:function (n) {
        ...
        Array.prototype.forEach.call(this.container.querySelectorAll('.num'), function (item,i) {
            ...
            item.style.cssText += 'transition-duration:0s;-ms-transition-duration:0s;-moz-transition-duration:0s;-webkit-transition-duration:0s;-o-transition-duration:0s;transform:translateY(0);-ms-transform:translateY(0);-moz-transform:translateY(0);-webkit-transform:translateY(0);-o-transform:translateY(0)';//重置位置
            item.innerHTML = gapStr;
            setTimeout(function () {
                item.style.cssText+='transition-duration:1s;-ms-transition-duration:1s;-moz-transition-duration:1s;-webkit-transition-duration:1s;-o-transition-duration:1s;transform:translateY(-'+self.rollHeight*gapNum+'px);-ms-transform:translateY(-'+self.rollHeight*gapNum+'px);-moz-transform:translateY(-'+self.rollHeight*gapNum+'px);-webkit-transform:translateY(-'+self.rollHeight*gapNum+'px);-o-transform:translateY(-'+self.rollHeight*gapNum+'px);';
            },50)
        })
    },
    /**
